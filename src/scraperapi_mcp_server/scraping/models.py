...
class Scrape(BaseModel):
    ...
    render: Annotated[bool, Field(default=False, description="Whether to render the page using JavaScript. Set to `True` only if the page requires JavaScript rendering to display its content.")]
